			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<!-- BEGIN USER FORM -->
						<form action="capnhatmoi.php?id=<?php echo $id ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
								<label class="control-label">Name :</label>
								<div class="controls">
									<input type="text" class="span11" placeholder="Product name" name="name" value="<?php echo $a[0]['name'] ?>" /> 
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="type_id">
										...
										<option <?php if($value['type_ID'] == $a[0]['type_ID']) {echo "selected='selected'";} ?> value="<?php echo $value['type_ID'] ?>"><?php echo $value['type_name'] ?></option>
										<?php
										}
										?>
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="manu_id">
										...
										<option <?php if($value['manu_ID'] == $a[0]['manu_ID']) {echo "selected='selected'";} ?> value=" <?php echo $value['manu_ID'] ?>"><?php echo $value['manu_name'] ?></option>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea class="span11" placeholder="Description" name = "description"><?php echo $a[0]['description'] ?>
										</textarea>
									</div>
									<div class="control-group">
										<label class="control-label">Price :</label>
										<div class="controls">
											<input type="text" class="span11" placeholder="price" name = "price" value="<?php echo $a[0]['price'] ?>" />
										</div>
									...
									<div class="form-actions">
											...
											<button type="submit" class="btn btn-success">SaveAdd</button>
